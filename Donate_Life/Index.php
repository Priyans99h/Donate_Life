<!DOCTYPE html>
<html lang="en">
<?php include("BeforeLogin\BeforeHead.php"); ?>
...
<body>
    <?php include("BeforeLogin\BeforeHeader.php"); ?>
...
<section class="w3ls-bnrbtm py-2" id="about">
    ...
    <!-- Additional Sections (You can add more sections as needed) -->
    ...
    <?php include("BeforeLogin\BeforeFooter.php"); ?>
